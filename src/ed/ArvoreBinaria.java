...
public class ArvoreBinaria implements EstruturaDeDado{
    private Object raiz;
    ...
    public void adicionar(Object elemento){
        if(raiz==null){
            ...
            if(raiz.hashCode() < elemento.hashCode()){
                if(direita == null)
                    direita = new ArvoreBinaria();
                direita.adicionar(elemento);
            }else if(raiz.hashCode() > elemento.hashCode()){
                if(esquerda == null)
                    esquerda = new ArvoreBinaria();
                esquerda.adicionar(elemento);
            }
        }
    }
    public void adicionar(Object[] elemento){
        for (int i = 0; i < elemento.length; i++) {
            adicionar(elemento[i]);
        }
    }
        ...
        if(elemento != null){
            ...
            if(aux != null){
                if(aux.direita == null && aux.esquerda == null){
                    ...
                    ArvoreBinaria menor = aux.direita;
                    ArvoreBinaria paiDoMenor = null;
